...
### Contrast matrix
{
  ...
  # =========================== Carbon sources effects ===============================
  # Glycerol ---> LCFA Fe+
    C5C6vsC11C12 <- makeContrasts(C11vsC12-C5vsC6,levels=design)

  # Glycerol ---> LCFA Fe-
    C5C6vsC11C12_Fe_NO <- makeContrasts(C11vsC12_Fe_NO-C5vsC6_Fe_NO,levels=design)

    second_order_contrast_1 <- makeContrasts(C5C6vsC11C12,C5C6vsC11C12_Fe_NO,levels=design)
}
...
titles <- c("Iron_effect_in_EXP_(GLYCEROL-DEXTROSE)","Iron_effect_in_EXP_(GLYCEROL)",
            ...
            "Carbon_source_effects_in_presence_of_Fe_(GLYCEROL -> LCFA)",
            "Carbon_source_effects_in_absence_of_Fe_(GLYCEROL -> LCFA)")
