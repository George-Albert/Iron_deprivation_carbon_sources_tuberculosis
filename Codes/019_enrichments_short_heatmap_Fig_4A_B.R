...
hclust_matrix <- hclust_matrix[-c(1:3,6,14,17:19,26,28:30,31,33,39:42,46,47,49:52),]
...
hclust_matrix[(is.infinite(hclust_matrix))] <- NA
...
hclust_matrix <- hclust_matrix[-c(1,3,13:14,16,20:32,35:42,46:48,51,53:55,58:60),]
