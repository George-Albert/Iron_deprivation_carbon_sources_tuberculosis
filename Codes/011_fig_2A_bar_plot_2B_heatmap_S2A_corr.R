...
pdf(file=file.path(output_dir,"001_Figures_paper","6_Figure_2A_Barplot_DE_genes_iron_effects.pdf"),width=7,height=7)
print(bar_pl_1)
dev.off()
...
dir.create(file.path(output_dir,"001_Figures_paper"))
filename=file.path(output_dir,"001_Figures_paper","7_Fig_2B_Heatmap_iron_effects_at_exp.pdf")

pdf(file =filename )
print(grid_plt)
dev.off()

filename=file.path(output_dir,"001_Figures_paper","7_Fig_2B_Heatmap_iron_effects_at_exp_wo_dend.pdf")
...
for (col in vector_to_loop) {
  ...
  print(pl_scatter_1)
  scatter_dir <- "001_Figures_paper/9_Figure_S2A_Scatter_plot_correlation_stat_vs_interactions"
